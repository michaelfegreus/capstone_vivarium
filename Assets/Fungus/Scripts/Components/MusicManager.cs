...
namespace Fungus
{
    ...
    public class MusicManager : MonoBehaviour
    {
        ...
        /// </summary>
        public virtual void FadeOutMusic(float _fadeTime)
        {
			if (audioSourceMusic.isPlaying)
			{
				StartCoroutine(FadeOut(audioSourceMusic, _fadeTime));
			}
        }
        ...
        IEnumerator FadeOut(AudioSource audioSource, float FadeTime)
        {
            ...
            audioSource.Stop();
			audioSourceMusic.volume = 1f; // Set the volume back to full after it has stopped.
        }
