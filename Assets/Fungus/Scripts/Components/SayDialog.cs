...
namespace Fungus
{
    ...
    public class SayDialog : MonoBehaviour
    {
        ...
        [SerializeField] protected SuperTextMesh nameText; // CHANGED TO SUPERTEXTMESH for VIVARIUM
        ...
        [SerializeField] protected SuperTextMesh storyText; // CHANGED TO SUPERTEXTMESH for VIVARIUM
        ...
        public virtual RectTransform StoryTextRectTrans
        {
            get
            {
                // Original script before changed for Vivarium:
                //return storyText != null ? storyText.rectTransform : storyTextGO.GetComponent<RectTransform>();
                return storyText != null ? storyText.GetComponent<RectTransform>() : storyTextGO.GetComponent<RectTransform>();
            }
        }
