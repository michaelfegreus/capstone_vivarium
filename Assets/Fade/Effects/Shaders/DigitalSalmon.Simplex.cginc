#ifndef DIGITALSALMON_SIMPLEX_INCLUDED
#define DIGITALSALMON_SIMPLEX_INCLUDED
...
float simplex(float v) {
	return simplex(float2(v, 0));
}
...
#endif // DIGITALSALMON_SIMPLEX_INCLUDED