...
//     version 1.8.0
//     from Assets/Opsive/Shared/Input/InputSystem/CharacterInput.inputactions
//
...
public partial class @CharacterInput: IInputActionCollection2, IDisposable
{
    ...
    ~@CharacterInput()
    {
        Debug.Assert(!m_Gameplay.enabled, "This will cause a leak and performance issues, CharacterInput.Gameplay.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, CharacterInput.UI.Disable() has not been called.");
    }
