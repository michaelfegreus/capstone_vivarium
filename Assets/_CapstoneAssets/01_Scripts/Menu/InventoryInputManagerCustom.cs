...
namespace MoreMountains.InventoryEngine
{
    ...
    /// </summary>
    public class InventoryInputManagerCustom : MonoBehaviour, MMEventListener<MMInventoryEvent>
    {
        [Header("Targets")]
        ...
        protected MenuInput menuControls;
        /*
        [Header("Key Mapping")]
        ...
        */
        ...
        protected virtual void Start()
        {
            ...
            // Set up new input system function call events
            menuControls.InventoryEngine.ToggleInventory.performed += _ => ToggleInventory();
            menuControls.InventoryEngine.Hotbar.performed += _ => HotbarsInput();
            // Add the following controls when the inventory is open if InputOnlyWhenOpen is not required
            if (!InputOnlyWhenOpen)
            {
                menuControls.InventoryEngine.Cancel.performed += _ => CloseInventory();
                menuControls.InventoryEngine.PrevInv.performed += _ => PreviousInventory();
                menuControls.InventoryEngine.NextInv.performed += _ => NextInventory();
                menuControls.InventoryEngine.Move.performed += _ => Move();
                menuControls.InventoryEngine.Equip.performed += _ => Equip();
                menuControls.InventoryEngine.EquiporUse.performed += _ => EquipOrUse();
                menuControls.InventoryEngine.Use.performed += _ => Use();
                menuControls.InventoryEngine.Drop.performed += _ => Drop();
            }
        }
        ...
        public virtual void OpenInventory()
        {
            ...
            // Add the following controls when the inventory is open if InputOnlyWhenOpen
            if (InputOnlyWhenOpen)
            {
                menuControls.InventoryEngine.Cancel.performed += _ => CloseInventory();
                menuControls.InventoryEngine.PrevInv.performed += _ => PreviousInventory();
        ...
        public virtual void CloseInventory()
        {
            ...
            // Remove the following controls when the inventory is open if InputOnlyWhenOpen
            if (InputOnlyWhenOpen)
            {
                menuControls.InventoryEngine.Cancel.performed -= _ => CloseInventory();
                menuControls.InventoryEngine.PrevInv.performed -= _ => PreviousInventory();
        ...
        // Alright so...the below is me trying to put together the inventory input with the New Input System

        protected virtual void PreviousInventory()
        {
        ...
        protected virtual void NextInventory()
        {
            if (_currentInventoryDisplay.GoToInventory(1) != null)
            {
                _currentInventoryDisplay = _currentInventoryDisplay.GoToInventory(1);
        ...
        protected virtual void HotbarsInput()
        {
            if (!InventoryIsOpen)
            {
        ...
        /// And I also enable the input system controls
        /// </summary>
        ...
        /// And disable input system controls
        /// </summary>
