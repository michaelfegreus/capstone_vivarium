...
//     version 1.8.0
//     from Assets/_CapstoneAssets/01_Scripts/Input/MenuInput/MenuInput.inputactions
//
...
public partial class @MenuInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""545fa533-8b8e-4ee4-8ea9-797578937522"",
                    ""path"": ""<DualShockGamepad>/buttonEast"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""e0d6d61c-3bd8-4421-80b2-bac5b2240f80"",
                    ""path"": ""<SwitchProControllerHID>/buttonEast"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        },
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""139c0d12-984d-4e5f-a7bb-a6b4d318da58"",
                ...
                {
                    ""name"": """",
                    ""id"": ""caa3b2a6-06d9-4c4a-bef5-a9f7f4ff1688"",
                ...
                {
                    ""name"": """",
                    ""id"": ""007bdb86-20ca-46c7-a03c-30741da8d869"",
                ...
                {
                    ""name"": """",
                    ""id"": ""52a579bd-f5c0-4cc3-9899-383e958e4142"",
                ...
                {
                    ""name"": """",
                    ""id"": ""eec0903a-6f05-46e6-a0bb-62ed34c291f5"",
                    ""path"": ""<SwitchProControllerHID>/start"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""bf0b36ca-fdd1-4ba2-afe4-3cfb573b40e3"",
                    ""path"": ""<SwitchProControllerHID>/buttonNorth"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@MenuInput()
    {
        Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, MenuInput.Player.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, MenuInput.UI.Disable() has not been called.");
        Debug.Assert(!m_InventoryEngine.enabled, "This will cause a leak and performance issues, MenuInput.InventoryEngine.Disable() has not been called.");
        Debug.Assert(!m_NotebookNavigation.enabled, "This will cause a leak and performance issues, MenuInput.NotebookNavigation.Disable() has not been called.");
    }
    ...
    private List<IInventoryEngineActions> m_InventoryEngineActionsCallbackInterfaces = new List<IInventoryEngineActions>();
    ...
    public struct InventoryEngineActions
    {
        ...
        public void AddCallbacks(IInventoryEngineActions instance)
        {
            if (instance == null || m_Wrapper.m_InventoryEngineActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_InventoryEngineActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IInventoryEngineActions instance)
        {
            @ToggleInventory.started -= instance.OnToggleInventory;
            @ToggleInventory.performed -= instance.OnToggleInventory;
            @ToggleInventory.canceled -= instance.OnToggleInventory;
        ...
        public void RemoveCallbacks(IInventoryEngineActions instance)
        {
            if (m_Wrapper.m_InventoryEngineActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IInventoryEngineActions instance)
        {
            foreach (var item in m_Wrapper.m_InventoryEngineActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_InventoryEngineActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    ...
    private List<INotebookNavigationActions> m_NotebookNavigationActionsCallbackInterfaces = new List<INotebookNavigationActions>();
    ...
    public struct NotebookNavigationActions
    {
        ...
        public void AddCallbacks(INotebookNavigationActions instance)
        {
            if (instance == null || m_Wrapper.m_NotebookNavigationActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_NotebookNavigationActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(INotebookNavigationActions instance)
        {
            @FlipRight.started -= instance.OnFlipRight;
            @FlipRight.performed -= instance.OnFlipRight;
            @FlipRight.canceled -= instance.OnFlipRight;
        ...
        public void RemoveCallbacks(INotebookNavigationActions instance)
        {
            if (m_Wrapper.m_NotebookNavigationActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(INotebookNavigationActions instance)
        {
            foreach (var item in m_Wrapper.m_NotebookNavigationActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_NotebookNavigationActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
